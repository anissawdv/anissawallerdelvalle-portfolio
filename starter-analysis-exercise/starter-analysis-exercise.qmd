...
The str command in R is short for structure. Running this command enables users to display the internal structure of an R object. I will run this command to display the structure of the gapminder dataset.
...
![](Life Expectancy vs. Infant Mortality in Africa.png)
...
![](Life Expectancy vs. Population in Africa.png)
...
![](Life Expectancy vs. Infant Mortality in Africa (2000).png)
...
![](Life Expectancy vs. Population in Africa (2000).png)
...
```         
fit1 <- lm(life_expectancy ~ infant_mortality, data = africa_yr2000) summary(fit1)
```
...
```         
fit2 <- lm(life_expectancy ~ population, data = africa_yr2000) summary(fit2)
```
